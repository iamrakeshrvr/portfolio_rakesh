...
function ContactMe({}: Props){
    ...
    const onSubmit: SubmitHandler<Inputs> = (formData) => {
        window.location.href = `mailto:rakeshrvr1998@gmail.com?subject=${formData.subject}&body=Hi, my name is ${formData.name}. ${formData.message}
        (${formData.email})`;
    }
  ...
  return (
    ...
    <div className='h-screen flex relative flex-col text-center md:text-left md:flex=row max-w-7xl px-10 justify-evenly mx-auto items-center'>
         {/*<h3 className='absolute top-24 uppercase tracking-[20px] text-white-500 text-2xl'>Contact</h3>*/} 
        ...
        <div className='flex flex-col space-y-10'>
            ...
            <div className='space-y-10'>
                ...
                {/*<div className='flex items-center space-x-5 justify-center'>
                    ...
                    <p className='text-2xl'>Sarnia, Lambton, Ontario, Canada</p>
                   </div>*/}
